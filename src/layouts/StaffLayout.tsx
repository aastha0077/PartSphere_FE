...
const StaffLayout = () => {
  const navLinks = [
    ...
    { to: '/staff/pos', icon: <Store size={20} />, label: 'POS Terminal' },
    ...
    { to: '/staff/orders', icon: <ShoppingCart size={20} />, label: 'Sales Orders' },
    ...
    <div className="min-h-screen bg-[#0a0a0c] flex">
      <aside className="w-72 border-r border-white/5 bg-[#0d0d12] flex flex-col fixed inset-y-0 z-50">
        ...
        <div className="p-6 bg-white/[0.02] m-4 rounded-2xl border border-white/5">
          <p className="text-[10px] font-bold text-emerald-500 uppercase mb-2">Staff Portal</p>
          <p className="text-xs text-gray-400 leading-relaxed">
            Register customers, process sales, and manage service appointments.
          </p>
        </div>
      </aside>
